...
namespace ModularityTimeline\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_TIMELINE_PATH . apply_filters(
            'ModularityTimeline/Helper/CacheBust/RevManifestPath',
            'dist/manifest.json'
        );
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_TIMELINE_PATH . ' and run gulp. See ' . MODULARITY_TIMELINE_PATH . 'README.md for more info.</div>';
        }
    }
}
